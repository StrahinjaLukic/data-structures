...
INSTANTIATE_TEST_SUITE_P(
    ...
    IteratorTest,
    testing::Values(
        IteratorTestData{{{10, "ten"}, {11, "eleven"}, {5, "five"}},
                         {{OperationType::kInsert, 6, "six"}, {OperationType::kRemove, 10, ""}},
                         {{5, "five"}, {6, "six"}, {11, "eleven"}},
                         "Simple"},
        IteratorTestData{{{10, "ten"}, {8, "eight"}, {15, "fifteen"}, {11, "eleven"}, {5, "five"}},
                         {{OperationType::kInsert, 6, "six"},
                          {OperationType::kRemove, 10, ""},
                          {OperationType::kRemove, 2, ""},
                          {OperationType::kInsert, 16, "sixteen"}},
                         {{5, "five"},
                          {6, "six"},
                          {8, "eight"},
                          {11, "eleven"},
                          ...
                          {16, "sixteen"}},
                         "RemoveNonExisting"},
        IteratorTestData{{{10, "ten"}, {8, "eight"}, {7, "seven"}, {6, "six"}, {5, "five"}},
                         {{OperationType::kInsert, 11, "eleven"},
                          {OperationType::kRemove, 10, ""},
                          {OperationType::kInsert, 3, "three"},
                          {OperationType::kInsert, 4, "four"}},
                         {{3, "three"},
                          {4, "four"},
                          {5, "five"},
                          {6, "six"},
                          ...
                          {11, "eleven"}},
                         "MostlyBackwards"}),
    [](const testing::TestParamInfo<IteratorTest::ParamType>& info) { return info.param.name; });
